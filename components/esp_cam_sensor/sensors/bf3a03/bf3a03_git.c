 ...
 *https://github.com/bambooHaw/sunxi-vfe/blob/c0094711d1e14696b95c0d35809668fd9d279e92/device/bf3a03.c#L12
 */
/*
 ...
 * The white balance enable bit is modified in sensor_s_autowb and sensor_s_wb
 */
...
static int sensor_power(struct v4l2_subdev *sd, int on)
{
    ...
    case CSI_SUBDEV_STBY_OFF:
        ...
        //if(ret < 0)
        //  vfe_dev_err("soft stby off failed!\n");
        //usleep_range(10000,12000);
...
/*
 * Implement G/S_param.  There is a "high quality" mode we could try
 * to do someday; for now, we just do the frame rate tweak.
 */
static int sensor_g_param(struct v4l2_subdev *sd, struct v4l2_streamparam *prams)
{
    struct v4l2_captureparam *cp = &prams->param.capture;
    //struct sensor_info *info = to_state(sd);

    if (prams->type != V4L2_BUF_TYPE_VIDEO_CAPTURE) {
        return -EINVAL;
    }

    memset(cp, 0, sizeof(struct v4l2_captureparam));
...
static int sensor_s_param(struct v4l2_subdev *sd, struct v4l2_streamparam *prams)
{
//  struct v4l2_captureparam *cp = &prams->param.capture;
 ...
 * if not support the follow function ,return -EINVAL
 */
                            ...
                            struct v4l2_queryctrl *qc)
{
    ...
    /* see sensor_s_param and sensor_g_param for the meaning of value */
...
static const struct v4l2_subdev_video_ops sensor_video_ops = {
    ...
    .s_param = sensor_s_param,
    .g_param = sensor_g_param,
