...
#define BF3A03_SPEC_EFFECT_REG_SIZE (10)

static const bf3a03_reginfo_t bf3a03_spec_effect_regs[6][BF3A03_SPEC_EFFECT_REG_SIZE] = {
    {
        {0x80, 0x0f},
        {0xd6, 0x61},
        {0xff, 0x01},
...
static const bf3a03_reginfo_t DVP_8bit_20Minput_640x480_yuv422_20fps_gray[] = {
    //{0x12,0x80},
    {0x09, 0x03}, //55
    {0x15, 0x02},
    {0x1e, 0x40}, //HV mirror
...
static const bf3a03_reginfo_t DVP_8bit_20Minput_640x480_yuv422_20fps_color[] = {
    //{0x12,0x80},
    {0x09, 0x03}, //55
    {0x15, 0x02},
    {0x1e, 0x40}, //HV mirror
